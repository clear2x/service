...
/**
 * 根据手机号查询用户，提供给PhoneSmsAuthenticationProvider使用
 *
 * @author yuangy
...
public class UserDetailByPhoneServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String phone) throws UsernameNotFoundException {
        ...
        SystemUser systemUser = userManager.findByPhone(phone);
        if (systemUser != null) {
